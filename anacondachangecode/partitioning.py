...
def _createFreeSpacePartitions(anaconda):
    ...
    # e.g modify for partion, swap_size + 16G(for / ) + 1G(for /home /boot )
    (lowerlimit_swap, upperlimit_swap) = iutil.swapSuggestion()
    base_size = 13312 + 20480 + 1024
    lowerlimit_max = lowerlimit_swap + base_size
    upperlimit_max = upperlimit_swap + base_size 
    ...
    for disk in anaconda.id.storage.partitioned:
        ...
        while part:
            ...
            if part.getSize(unit="MB") > lowerlimit_max:
                disks.append(disk)
                break
