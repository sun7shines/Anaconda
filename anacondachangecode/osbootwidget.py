...
class OSBootWidget:
    ...
    def __init__(self, anaconda, parent, blname = None):
        ...
        label = gtk.Label()
        label.set_markup("<span  foreground='#333333'><b>引导装载程序操作系统列表</b></span>")
        label.set_alignment(0.0, 0.0)
        label.set_property("use-markup", True)
        tmphbox = gtk.HBox(False,0)
        tmphbox.pack_start(label,False,False,0)
        
        """self.vbox.pack_start(label, False)"""
        self.vbox.pack_start(tmphbox,False,False,0)
        ###############################################################################
        ...
        sw.set_size_request(900,250)
        """box.pack_start(sw, True)"""
        
        tmphbox.pack_start(sw,False,False,0)
        self.vbox.pack_start(tmphbox,False,False,0)
        ...
        self.osTreeView.set_size_request(100, 104)
        ...
        buttonbar.set_spacing(20)
        add = gtk.Button(u"添加")
        l = add.get_children()[0]
        ...
        delete = gtk.Button(u"删除")
        l = delete.get_children()[0]
        lstr = "<span  foreground='#333333'><b>"+l.get_text()+"</b></span>"
        l.set_markup(lstr)
        ...
        tmphbox = gtk.HBox(False,0)
        tmphbox.pack_end(buttonbar,False,False,100)
        
        self.vbox.pack_end(tmphbox, False,False,25)
