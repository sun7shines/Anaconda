...
from backend import f_filtertype
from backend import f_network
from backend import f_parttype
#from backend import f_tasksel
from backend import f_complete
...
installSteps = [
    ...
    ("u_network", f_network, ),
    ("timezone", ),
#    ("accounts", ), # for root password input
    ("setuptime", setupTimezone, ),
    ("parttype", ),
    ("u_parttype", f_parttype ),
    ("cleardiskssel", ),
