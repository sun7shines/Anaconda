...
stepToClass = {
    "installationtype" : ("installation_type","InstallationTypeWindow"),
    ...
    "networkNext":("networkNext_gui","NetworkNextWindow"),
...
class WaitWindow:
    def __init__(self, title, text, parent = None):
        ...
        path = "/usr/share/anaconda/ui/waitwindow.glade"
        if os.access(path, os.F_OK):
            pass
        else:
            path = "/anaconda/ui/waitwindow.glade"
            
        self.mainxml = gtk.glade.XML(path,domain="anaconda")
        self.window = self.mainxml.get_widget("mainWindow")
        #############################################################
        
        i = self.mainxml.get_widget("headerImage")
        p = readImageFromFile("top.png",dither = False, image = i)
        ...
        self.ebox = self.mainxml.get_widget("eventbox")
        self.ebox.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse(bottomcolor))
        self.ebox.set_size_request(1024,98)
        ...
        fixed = gtk.Fixed()
        i = gtk.Image()
        path = "/usr/share/anaconda/pixmaps/icon5_storage_check.png"
        i.set_from_file(path)
        i.show()
        fixed.put(i,45,15)
        label1 = gtk.Label()
        lstr = "<span font_desc=' 16' weight='bold' foreground='"+fontcolor+"'><b>安装进度</b></span>"
        label1.set_markup(lstr)
        fixed.put(label1,160,23)
        label2 = gtk.Label()
        lstr = "<span font_desc=' 11.5' weight='bold' foreground='"+fontcolor+"'><b>正在安装操作系统....</b></span>"
        ...
        label = gtk.Label()
        spantext = "<span font=' 10.5' foreground='#333333' size='large'><b>"+text+"</b></span>"
        label.set_markup(spantext)
        ...
        self.installFrame.add(vbox)
        self.installFrame.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse("#e6e6e6"))
        self.window.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse("#e6e6e6"))
...
class ProgressWindow:
    def __init__(self, title, text, total, updpct = 0.05, updsecs=10,
        ...
        path = "/usr/share/anaconda/ui/progress.glade"
        if os.access(path, os.F_OK):
            pass
        else:
            path = "/anaconda/ui/progress.glade"
        ...
        fixed.put(i,45,15)
        label1 = gtk.Label()
        """label1.set_markup("<span font_desc=' 16' weight='bold' foreground='#e6e6e6'><b>检查存储：</b></span>")"""
        fixed.put(label1,160,23)
        label2 = gtk.Label()
        """label2.set_markup("<span font_desc=' 11.5' weight='bold' foreground='#e6e6e6'><b>检查所选择的存储设备</b></span>")"""
        fixed.put(label2,160,58)
        eboximage.add(fixed) 
        eboximage.show_all()
        vbox = gtk.VBox(False,0) 
        ...
        fix = gtk.Fixed()
        label = gtk.Label()
        spantext = "<span font=' 9.5' foreground='#333333' size='large'><b>"+text+"</b></span>"
        label.set_markup(spantext)
        align=gtk.Alignment(0.5,0.5,1.0,1.0)
        align.add(label)
        x = 512-(len(text)/2)*10
        ...
        eboxpro.set_size_request(800,23)
        fix.put(eboxpro,120,260)
...
class MessageWindow:
    ...
    def draw_pixbuf(self,widget, event):
        path = "/usr/share/anaconda/pixmaps/top.png"
        pixbuf = gtk.gdk.pixbuf_new_from_file(path)
        widget.window.draw_pixbuf(widget.style.bg_gc[gtk.STATE_NORMAL], pixbuf, 0, 0, 0,0)

    def modify_messagedialog(self,dialog,text,custom_buttons):
...
class "GtkButton" style "black-background" 
    """
        ...
        #import pdb;pdb.set_trace()
        vbox0 = dialog.get_children()[0]
        hbox00 = vbox0.get_children()[0]
        
        sep01 = vbox0.get_children()[1]
        hubox02 = vbox0.get_children()[2]
        vbox001 = hbox00.get_children()[1]
    
        hbox00.set_border_width(0)
        hubox02.set_border_width(0)
        vbox001.set_border_width(0)
    
        vbox0.remove(sep01)
        vbox0.remove(hbox00)
        vbox0.remove(hubox02)
        
        imagehbox1 = gtk.HBox()
        ebox1 = gtk.EventBox()
        imagehbox1.pack_start(ebox1,True,True)
        ebox1.set_app_paintable(True)
        ebox1.set_size_request(1024,50)
        ebox1.connect('expose-event',self.draw_pixbuf)
    
        imagehbox2 = gtk.HBox()
        ebox2 = gtk.EventBox()
        imagehbox2.pack_start(ebox2,True,True)
        ebox2.set_app_paintable(True)
        ebox2.set_size_request(1024,100)
        ...
        path = "/usr/share/anaconda/pixmaps/icon6_harddisk_initialization.png"
        i.set_from_file(path)
        i.show()
        fixed.put(i,45,15)
        label1 = gtk.Label()
        ...
        ebox2.add(fixed)
        ebox2.show_all()
        ebox2.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse(bgcolor))

        vbox0.pack_start(imagehbox1,False,False,0)
        vbox0.pack_start(imagehbox2,False,False,0)
        ###############################################################
        image001 = hbox00.get_children()[0]
        vbox002 = hbox00.get_children()[1]
        hbox00.remove(image001)
        hbox00.remove(vbox002)
        ...
        align=gtk.Alignment(0.5,0.5,1.0,1.0)
        align.add(label)
        hbox00.pack_start(align,True,True,0)
        
        ebox4 = gtk.EventBox()
        ebox4.add(hbox00)
        ebox4.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse("#e6e6e6"))
        ...
        ebox3 = gtk.EventBox()
        ebox3.set_app_paintable(True)
        ebox3.set_size_request(1024,98)
        ebox3.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse(bottomcolor))
        ebox3.add(hubox02)
        vbox0.pack_start(ebox3,False,False,0)
    
        ebox = gtk.EventBox()
        dialog.remove(vbox0)
        ebox.add(vbox0)
        ebox.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse(bgcolor))
        ebox.set_border_width(0)
        dialog.add(ebox)
    
        dialog.set_border_width(0)
        vbox0.set_spacing(0)
        vbox0.set_border_width(0)
        #################################################################
        
        buttons = hubox02.get_children()
        for button in buttons:
            hubox02.remove(button)
            button.set_size_request(120,35)
            l = button.get_children()[0]
            try:
                ltext = l.get_text()
                lstr = "<span font=' 9.5' foreground='#474747' size='large'><b>"+ltext+"</b></span>"
                l.set_markup(lstr)
            except:
                pass
        ...
        ebox5 = gtk.EventBox()
        hbox = gtk.HBox()   
        hbox.pack_end(ebox5,False,False,100)
        hubox02.pack_end(hbox,False,False)
        ...
        for button in buttons:
            if i == len(buttons):
                hbox1.pack_end(button,False,False,30)
            else:
                hbox1.pack_end(button,False,False)
            i = i+1
        
        ebox5.add(hbox1)
        ebox5.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse(bottomcolor))
        ebox5.show_all()
    ...
    def __init__ (self, title, text, type="ok", default=None, custom_buttons=None, custom_icon=None, run = True, parent = None, destroyAfterRun = True):
        ...
        #self.dialog=gtk.MessageDialog(mainWindow,0,style,buttons,None)
        self.dialog=gtk.MessageDialog(mainWindow,0,style,gtk.BUTTONS_NONE,None)
        
        # 添加按钮
        if type == 'ok':
            self.dialog.add_button('确定',gtk.RESPONSE_OK)
        elif type == 'warning':
            self.dialog.add_button('确定',gtk.RESPONSE_OK)
        elif type == 'okcancel':
            self.dialog.add_button('确定',gtk.RESPONSE_OK)
            self.dialog.add_button('取消',gtk.RESPONSE_CANCEL)
        elif type == 'yesno':
            self.dialog.add_button('是',gtk.RESPONSE_YES)
            self.dialog.add_button('否',gtk.RESPONSE_NO)
        elif type == 'custom':
            pass
        ...
        self.modify_messagedialog(self.dialog,text,custom_buttons)
        
        self.dialog.set_resizable(True)
        self.dialog.fullscreen()
        self.dialog.set_size_request(1024,768)
    ...
    def questionInitializeDisk(self, path, description, size, details=""):
        ...
        if self.anaconda.id.installationtype==True:
            ...
            """rc = self.messageWindow(_("Warning"),
                    _(u"处理驱动器时出错：\n\n%(path)s\n%(size)-0.fMB\n%(description)s\n\n可能需要重新初始化该设备。\n\n重新初始化将丢失所有数据！\n\n这个动作也适用于其他需要重新初始化的磁盘。%(details)s")
                    % {'path': path, 'size': size,
                       'description': description, 'details': details},
                    type="custom",
                    custom_buttons = [ _(u"保留所有数据(_K)"),
                                       _(u"丢弃所有数据(_D)")],
                    custom_icon="question")"""
            rc = self.messageWindow(_("Warning"),
                    _(u"处理驱动器时出错：可能需要重新初始化该设备。重新初始化将\n丢失所有数据！这个动作也适用于其他需要重新初始化的磁盘。"),
                    type="custom",
                    custom_buttons = [ _(u"保留数据"),
                                       _(u"丢弃数据")],
                    custom_icon="question")
            if rc==0:
                path = "all"
        ...
        return retVal
    def questionInitializeDisk_a(self, path, description, size, details=""):
...
class InstallControlWindow:
    ...
    def setScreen (self):
        ...
        # liuweifeng 第一个安装界面设置默认焦点为下一步
        #self.currentWindow.set_default(self.mainxml.get_widget("nextButton"))
        if className == "InstallationTypeWindow" or className == "InstallProgressWindow":
            ne = self.mainxml.get_widget("nextButton")
            ne.grab_focus()
            #labelback = self.mainxml.get_widget("labelback")
            #labelback.set_markup("<span font=' 10.5' foreground='#999999' size='large'><b>上一步</b></span>")
            backbutton = self.mainxml.get_widget("backButton")
            backbutton.hide()
        else:
            backbutton = self.mainxml.get_widget("backButton")
            try:
                ...
                pass
#         if className == "NetworkWindow":
#             ne = self.mainxml.get_widget("debugButton")
#             #ne.grab_focus()
        # liuweifeng 获取焦点修改按钮样式
        try:
            self.mainxml.get_widget("nextButton").connect("focus-in-event",self.focusInNext)
            self.mainxml.get_widget("nextButton").connect("focus-out-event",self.focusOutNext)
            self.mainxml.get_widget("backButton").connect("focus-in-event",self.focusInBack)
            self.mainxml.get_widget("backButton").connect("focus-out-event",self.focusOutBack)
        except:
            pass
    ...
    # 按钮事件处理
    def focusInNext(self,widget, event):
        labelback = self.mainxml.get_widget("labelback")
        labelnext = self.mainxml.get_widget("labelnext")
        labelreboot = self.mainxml.get_widget("labelreboot")
        labelnext.set_markup("<span font=' 10.5' foreground='#333333' size='large'><b>下一步</b></span>")
        #widget.set_size_request(45, 20)
        #widget.set_property("relief","normal")
        widget.set_property("border-width",2)
        #labelnext.set_property("border-width",2)
    def focusOutNext(self,widget, event):
        labelback = self.mainxml.get_widget("labelback")
        labelnext = self.mainxml.get_widget("labelnext")
        labelreboot = self.mainxml.get_widget("labelreboot")
        labelnext.set_markup("<span font=' 10.5' foreground='#555555' size='large'><b>下一步</b></span>")
        #widget.set_size_request(45, 20)
        #widget.set_property("relief","half")
        widget.set_property("border-width",0)
        #labelnext.set_property("border-width",0)
    def focusInBack(self,widget, event):
        labelback = self.mainxml.get_widget("labelback")
        labelnext = self.mainxml.get_widget("labelnext")
        labelreboot = self.mainxml.get_widget("labelreboot")
        labelback.set_markup("<span font=' 10.5' foreground='#333333' size='large'><b>上一步</b></span>")
        #widget.set_property("relief","normal")
        #widget.set_size_request(45, 20)
        widget.set_property("border-width",2)
    def focusOutBack(self,widget, event):
        labelback = self.mainxml.get_widget("labelback")
        labelnext = self.mainxml.get_widget("labelnext")
        labelreboot = self.mainxml.get_widget("labelreboot")
        labelback.set_markup("<span font=' 10.5' foreground='#555555' size='large'><b>上一步</b></span>")
        #widget.set_property("relief","half")
        #widget.set_size_request(45, 20)
        widget.set_property("border-width",0)
    ...
    def update (self, ics):
        ...
        if self.mainxml.get_widget("backButton"):
            self.mainxml.get_widget("backButton").set_sensitive(ics.getPrevEnabled())
        if self.mainxml.get_widget("nextButton"):
    ...
    def _doExitConfirm (self, win = None, *args):
        ...
        self._doExit()
    def draw_pixbuf(self,widget, event):
        #path = "/home/she/FVI_Install/interface/screen3_keyboard.jpg"
        #pixbuf = gtk.gdk.pixbuf_new_from_file(path)
        pixbuf = getPixbuf("bottom.png")
        widget.window.draw_pixbuf(widget.style.bg_gc[gtk.STATE_NORMAL], pixbuf, 0, 0, 0,0)

    def createWidgets (self):
        
        os.system("scp /mnt/stage2/isotype /root")
        
        self.window.set_title(_("%s Installer") %(productName,))

        i = self.mainxml.get_widget("headerImage")
        p = readImageFromFile("top.png",
        ...
        self.ebox = self.mainxml.get_widget("eventbox")
        #self.ebox.connect('expose-event', self.draw_pixbuf)
        self.ebox.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse(bottomcolor))
        self.ebox.set_size_request(1024,98)
        
        self.ebox1 = self.mainxml.get_widget("eventbox1")
        #self.ebox1.connect('expose-event', self.draw_pixbuf)
        self.ebox1.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse(bottomcolor))
        self.ebox1.set_size_request(1024,98)
        self.ebox1.show()
...
class "GtkButton" style "black-background" 
    """
        ...
        hbuttonbox2 = self.mainxml.get_widget("hbuttonbox2")
        hbuttonbox2.set_spacing(35)
        nextbutton = self.mainxml.get_widget("nextButton")
        backbutton = self.mainxml.get_widget("backButton")
        
        backbutton.set_size_request(120,35)
        nextbutton.set_size_request(120,35)
        labelback = self.mainxml.get_widget("labelback")
        labelnext = self.mainxml.get_widget("labelnext")
        labelreboot = self.mainxml.get_widget("labelreboot")
        labelback.set_markup("<span font=' 10.5' foreground='#333333' size='large'><b>上一步</b></span>")
        labelnext.set_markup("<span font=' 10.5' foreground='#333333' size='large'><b>下一步</b></span>")
        labelreboot.set_markup("<span font=' 10.5' foreground='#333333' size='large'><b>重新启动</b></span>")
    
        #liuweifeng 
        labelnext.grab_focus()
