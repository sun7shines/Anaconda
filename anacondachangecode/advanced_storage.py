...
def addFcoeDrive(anaconda):
    ...
    # liuweifeng
    label3 = dxml.get_widget("label3")
    lab = label3.get_property("label")
    #nlab = lab+"dfbdfgbdfbdfbdfbdfbdfb "
    label3.set_property("justify","GTK_JUSTIFY_LEFT")
    dialog.set_property("allow-grow",False)
