...
class Callbacks(object):
    def __init__(self, xml):
        ...
        self.sizeLabel.set_property("label",'选择了 %s 个设备（%sM），共 %s 个设备（%sM）。')
    ...
    def update(self, *args, **kwargs):
        ...
        global selectedSize, totalSize
        # liuweifeng
        self.sizeLabel.set_markup(_("选择了 %s 个设备（%sM），共 %s 个设备（%sM）。") % (selectedDevices, selectedSize, totalDevices, totalSize))
