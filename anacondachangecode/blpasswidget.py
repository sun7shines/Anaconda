...
class BootloaderPasswordWidget:
    def __init__(self, anaconda, parent):
        ...
        self.usePassCb = gtk.CheckButton(u"使用引导装载程序密码")
        l = self.usePassCb.get_children()[0]
        ...
        box.pack_start(self.passButton, False,False,104)
    ...
    def setPassLabel(self):
        ...
        self.passButton.set_label(_(u"修改密码"))  
        
        l = self.passButton.get_children()[0]
        lstr = "<span foreground='#333333'><b>"+l.get_text()+"</b></span>"
        l.set_markup(lstr)
